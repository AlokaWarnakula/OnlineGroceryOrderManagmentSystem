...
public class OrderServlet extends HttpServlet {
    ...
    private static final String ORDERS_FILE = "C:\\Users\\LENOVO\\IdeaProjects\\OnlineGroceryOrderManagmentSystem\\src\\main\\webapp\\data\\orders.txt";
    private static final String LOGGED_IN_USER_FILE = "C:\\Users\\LENOVO\\IdeaProjects\\OnlineGroceryOrderManagmentSystem\\src\\main\\webapp\\data\\loggedInUser.txt";

    @Override
    public void init() throws ServletException {
        File ordersDir = new File("C:\\Users\\LENOVO\\IdeaProjects\\OnlineGroceryOrderManagmentSystem\\src\\main\\webapp\\data");
        if (!ordersDir.exists()) {
            ordersDir.mkdirs();
